  ...
  const calculated: CalculatedCosts = useMemo(() => {
    ...
    const totalWeight = items.reduce((acc, item) => {
      ...
      return acc + (material ? material.unitWeight * item.quantity : 0);
        ...
        const totalManufacturingCostPerItem = laborIndirectCosts;

    return {
      materialCost,
      totalGrossCost: materialCost,
            indirectCosts: laborIndirectCosts,
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-surface p-6 rounded-lg shadow-md">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label htmlFor="laborCost" className="block text-sm font-medium text-textSecondary mb-1">Custos Fixos de Fabricação (R$)</label>
                            <input 
                                id="laborCost"
                                type="number"
                                value={laborCost}
                        ...
                        <div className="col-span-full grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-textSecondary mb-1">Valor Hora Homem (R$)</label>
                                <input 
                                    type="number"
                                    value={manHourRate}
                                    onChange={e => setManHourRate(parseFloat(e.target.value) || 0)}
                                    className="block w-full px-3 py-2 border border-gray-600 bg-gray-700 text-textPrimary rounded-md shadow-sm focus:outline-none focus:ring-primary focus:border-primary sm:text-sm"
                                />
                            </div>
                        </div>
                        ...
                        <div className="col-span-full grid grid-cols-1 sm:grid-cols-3 gap-3 items-end">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-textSecondary mb-1">Valor Hora Máquina (R$)</label>
                                <input 
                                    type="number"
            ...
            <div className="lg:col-span-1">
                <div className="bg-surface p-6 rounded-lg shadow-md sticky top-8">
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                            <span className="text-textSecondary">Custos Fixos de Fabricação:</span>
                            <span className="font-medium text-textPrimary">R$ {laborCost.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between">
                    ...
                    <div className="mt-6 space-y-3">
                        <button 
                          ...
                          disabled={items.length === 0 && manHours === 0 && machineHours === 0} 
                          className="w-full flex items-center justify-center px-4 py-2 bg-secondary text-white rounded-md hover:bg-green-600 transition-colors disabled:bg-gray-600 disabled:cursor-not-allowed"
                        >
