      ...
      <div className="bg-surface p-6 rounded-lg shadow-md space-y-6">
        <div>
          ...
          <input 
            ...
            className="block w-full px-3 py-2 border border-border bg-surface-light text-textPrimary rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary sm:text-sm transition-colors"
          />
        </div>
        <div>
        ...
        <div>
            ...
            <div className="mt-2 flex items-center space-x-4">
                {localSettings.companyLogo && <img src={localSettings.companyLogo} alt="logo" className="h-16 w-16 object-contain border p-1 rounded-md bg-surface-light border-border"/>}
                <input type="file" accept="image/*" onChange={handleLogoChange} className="block text-sm text-textSecondary file:mr-4 file:py-2 file:px-4 file:rounded-full file:border border-border file:text-sm file:font-semibold file:bg-surface-light file:text-textPrimary hover:file:border-primary hover:file:text-primary hover:file:bg-surface transition-colors"/>
            </div>
        </div>
        <div className="flex justify-between items-center pt-4">
          ...
          <div className="flex items-center space-x-3">
            <button onClick={handleMigrateLocalStorage} className="px-4 py-2 bg-surface-light text-textPrimary border border-border rounded-md hover:border-primary hover:text-primary transition-colors">Migrar dados locais</button>
