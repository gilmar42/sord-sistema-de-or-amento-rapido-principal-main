...
describe('QuoteCalculator - Testes de Produção', () => {
  ...
  describe('Cálculos Automáticos', () => {
    it('deve calcular custo total baseado nos componentes', async () => {
      ...
      await waitFor(() => {
        ...
        const calculationSection = screen.getByText(/Resumo Financeiro/i);
  ...
  describe('Gestão de Itens', () => {
    it('deve adicionar múltiplos materiais', async () => {
      ...
      await waitFor(() => {
        const deleteButtons = screen.getAllByLabelText(/Remover item/i);
    ...
    it('deve remover um item da lista', async () => {
      ...
      // Remover item
      const deleteButton = screen.getByLabelText(/Remover item/i);
      fireEvent.click(deleteButton);

      await waitFor(() => {
        expect(screen.queryByLabelText(/Remover item/i)).not.toBeInTheDocument();
      });
    });
  });
  ...
  describe('Salvamento de Orçamento', () => {
    ...
    it('deve validar nome do cliente antes de salvar', async () => {
      ...
      // Adicionar material sem nome do cliente
      const addButton = screen.getByText(/Adicionar Material/i);
      fireEvent.click(addButton);
