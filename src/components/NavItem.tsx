    ...
    <button
      ...
      className={`group relative flex flex-col md:flex-row items-center justify-center md:justify-start w-full px-2 py-3 md:py-2 text-sm font-medium rounded-lg transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 overflow-hidden ${
        currentView === view 
          ...
          : 'text-slate-900 dark:text-slate-300 hover:bg-sidebar-100 dark:hover:bg-slate-700 hover:text-slate-900 dark:hover:text-slate-100 hover:shadow-lg'
      }`}
    >
      ...
      <div className={`transition-all duration-300 ease-in-out ${
        currentView === view 
          ...
          : 'text-slate-700 dark:text-slate-300 group-hover:scale-110 group-hover:text-sidebar-600 dark:group-hover:text-blue-400'
      }`}>
        {icon}
      </div>
      ...
      <span className={`mt-1 md:mt-0 md:ml-3 text-xs md:text-sm transition-all duration-300 ease-in-out ${
        currentView === view 
          ...
          : 'text-slate-900 dark:text-slate-300 group-hover:text-sidebar-700 dark:group-hover:text-blue-400 group-hover:font-medium'
      }`}>
        {label}
      </span>
